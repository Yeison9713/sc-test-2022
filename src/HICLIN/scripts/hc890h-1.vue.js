...
module.exports = Vue.component("content_hc890h", {
    props: {
        params: {
            estado: false,
            pregunta: 0,
    ...
    watch: {
        ...
        "covid.consenti_inform_covid19": function (val) {
            val = val || "";
    ...
    methods: {
            ...
            POPUP(
                {
                    ...
                    seleccion: _this.covid.consenti_inform_covid19,
                    callback_f: _this._validarPersonalSalud,
                },
                (data) => {
                    _this.covid.consenti_inform_covid19 = data.COD;
                    _this._terminar();
                }
            );
        },
        ...
        _onValidarTipoIdAcompa() {
            ...
            let id = parseFloat(this.covid.acompanante_covid19.id_acomp_covid19);
            if (tipo == "CC") {
        ...
        _validarDiabetes() {
            ...
            validarInputs(
                ...
                _this._escape,
                () => {
                    let diabetes = _this._validarSioNo(_this.covid.paci_confirmado_covid19.diabetes_covid19);

                    _this.covid.paci_confirmado_covid19.diabetes_covid19 = diabetes;
        ...
        _validarEnfCardiovascular() {
            ...
            validarInputs(
                ...
                () => {
                    let cardiovascular = _this._validarSioNo(_this.covid.paci_confirmado_covid19.enf_cardiovas_covid19);

                    _this.covid.paci_confirmado_covid19.enf_cardiovas_covid19 = cardiovascular;
        ...
        _validarFallaRenal() {
            ...
            validarInputs(
                ...
                _this._validarEnfCardiovascular,
                () => {
                    let falla_renal = _this._validarSioNo(_this.covid.paci_confirmado_covid19.falla_renal_covid19);
                    _this.covid.paci_confirmado_covid19.falla_renal_covid19 = falla_renal;
                    _this._validarVih();
                }
            );
        },
        _validarVih() {
            ...
            validarInputs(
                ...
                _this._validarFallaRenal,
                () => {
                    let vih = _this._validarSioNo(_this.covid.paci_confirmado_covid19.vih_covid19);
                    _this.covid.paci_confirmado_covid19.vih_covid19 = vih;
        ...
        _validarCancer() {
            ...
            validarInputs(
                ...
                _this._validarVih,
                () => {
                    let cancer = _this._validarSioNo(_this.covid.paci_confirmado_covid19.cancer_covid19);
                    _this.covid.paci_confirmado_covid19.cancer_covid19 = cancer;
        ...
        _validarEnfAutoInmunes() {
            ...
            validarInputs(
                ...
                _this._validarCancer,
                () => {
                    let autoinmunes = _this._validarSioNo(_this.covid.paci_confirmado_covid19.enf_autoinmun_covid19);
                    _this.covid.paci_confirmado_covid19.enf_autoinmun_covid19 = autoinmunes;
        ...
        _validarHipotiroidismo() {
            ...
            validarInputs(
                ...
                _this._validarEnfAutoInmunes,
                () => {
                    let hipotiroidismo = _this._validarSioNo(_this.covid.paci_confirmado_covid19.hipotiroid_covid19);
                    _this.covid.paci_confirmado_covid19.hipotiroid_covid19 = hipotiroidismo;
        ...
        _validarCortico() {
            ...
            validarInputs(
                ...
                _this._validarHipotiroidismo,
                () => {
                    let cortico = _this._validarSioNo(_this.covid.paci_confirmado_covid19.cortico_inmuno_covid19);
                    _this.covid.paci_confirmado_covid19.cortico_inmuno_covid19 = cortico;
        ...
        _validarEpocAsma() {
            ...
            validarInputs(
                ...
                _this._validarCortico,
                () => {
                    let epoc_asma = _this._validarSioNo(_this.covid.paci_confirmado_covid19.epoc_asma_covid19);
                    _this.covid.paci_confirmado_covid19.epoc_asma_covid19 = epoc_asma;
        ...
        _validarMalNutricion() {
            ...
            validarInputs(
                ...
                _this._validarEpocAsma,
                () => {
                    let nutricion = _this._validarSioNo(_this.covid.paci_confirmado_covid19.mal_nutricion_covid19);
                    _this.covid.paci_confirmado_covid19.mal_nutricion_covid19 = nutricion;
        ...
        _validarFumadores() {
            ...
            validarInputs(
                ...
                _this._validarMalNutricion,
                () => {
                    let fumadores = _this._validarSioNo(_this.covid.paci_confirmado_covid19.fumadores_covid19);
                    _this.covid.paci_confirmado_covid19.fumadores_covid19 = fumadores;
                    _this._terminar();
                }
            );
        },
        ...
        _ventanaPacientesCovid() {
            parametros = {
                ...
                callback: (data) => {
                    ...
                    this.covid.acompanante_covid19.id_acomp_covid19 = parseFloat(data.COD);
        ...
        _escape() {
            this.modal_descripciones = false;
    ...
    template: /*html*/
        `<div>
            <transition name="modal_prosoft" v-if="modal_descripciones">
                                    ...
                                    <div class="portlet light box-center box-title">
                                        <div class="portlet-title">
                                            <div class="caption" style="width: 100%">
                                                <span class="caption-subject bold">Covid-19 (Corononavirus)</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12" style="text-align: left; padding-left: 15px;">
                                            ...
                                            <div class="col-md-12 no-padding" style="border-top: 1.5px solid rgb(236, 236, 236);">
                                                ...
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group " id="validarViajeFuera">
                                                    <label class="label-center">Ha viajado fuera del país en los últimos 14 días ?</label>
                                                    <div class="col-md-2 no-padding inline-inputs float-right">
                                                        <input type="text" disabled="disabled"
                                                            class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                      ...
                                                      <div class="form-group col-md-12 col-sm-12 col-xs-12 no-padding">
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-3" id="fase_id_acompa">
                                                            ...
                                                            <div class="input-group col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                v-model="covid.acompanante_covid19.id_acomp_covid19" data-orden="1" maxlength="15" 
                                                      ...
                                                      <div class="form-group col-md-12 col-sm-12 col-xs-12 no-padding">
                                                        <div class="col-md-5 col-sm-5 col-xs-5" id="fase_diabetes">
                                                          ...
                                                          <div class="inline-inputs col-md-4 col-sm-4 col-xs-4 float-right">
                                                              <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                  v-model="covid.paci_confirmado_covid19.diabetes_covid19" data-orden="1" maxlength="1" placeholder="N" disabled>
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-7 col-sm-7 col-xs-7" id="fase_enf_cardio">
                                                            ...
                                                            <div class="inline-inputs col-md-3 col-sm-3 col-xs-3 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.enf_cardiovas_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                         <div class="salto-linea"></div>
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-5" id="fase_falla_renal">
                                                            ...
                                                            <div class="inline-inputs col-md-4 col-sm-4 col-xs-4 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.falla_renal_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-7 col-sm-7 col-xs-7" id="fase_vih_inmuno">
                                                            ...
                                                            <div class="inline-inputs col-md-3 col-sm-3 col-xs-3 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.vih_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="salto-linea"></div>
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-5" id="fase_cancer">
                                                            ...
                                                            <div class="inline-inputs col-md-4 col-sm-4 col-xs-4 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.cancer_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-7 col-sm-7 col-xs-7" id="fase_enf_autoinmunes">
                                                            ...
                                                            <div class="inline-inputs col-md-3 col-sm-3 col-xs-3 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.enf_autoinmun_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="salto-linea"></div>
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-5" id="fase_hipotiroidismo">
                                                            ...
                                                            <div class="inline-inputs col-md-4 col-sm-4 col-xs-4 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.hipotiroid_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-7 col-sm-7 col-xs-7" id="fase_cortico">
                                                            ...
                                                            <div class="inline-inputs col-md-3 col-sm-3 col-xs-3 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.cortico_inmuno_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="salto-linea"></div>
                                                        ...
                                                        <div class="col-md-5 col-sm-5 col-xs-5" id="fase_epoc_asma">
                                                            ...
                                                            <div class="inline-inputs col-md-4 col-sm-4 col-xs-4 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.epoc_asma_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-7 col-sm-7 col-xs-7" id="fase_mal_nutricion">
                                                            ...
                                                            <div class="inline-inputs col-md-3 col-sm-3 col-xs-3 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.mal_nutricion_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="salto-linea"></div>
                                                        <div class="col-md-5 col-sm-5 col-xs-5" id="fase_fumadores">
                                                            ...
                                                            <div class="inline-inputs col-md-4 col-sm-4 col-xs-4 float-right">
                                                                <input type="text" class="form-control col-md-12 col-sm-12 col-xs-12 center uppercase"
                                                                v-model="covid.paci_confirmado_covid19.fumadores_covid19"  data-orden="1" maxlength="1" placeholder="N" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="salto-linea"></div>
                                                        <div class="salto-linea"></div>
