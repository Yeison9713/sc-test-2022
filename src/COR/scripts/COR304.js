...
new Vue({
    ...
    created() {
        ...
        nombreOpcion('4 - Listado control de respuestas');
        _inputControl('reset');
    ...
    methods: {
        ...
        formato_impresion(data = [], fechas = {}) {
            ...
            let width_tabla_pdf = ['auto', 'auto', 'auto', '*', 'auto', 'auto', 'auto', 'auto', 'auto', 'auto', 'auto']
            ...
            if (formato == 1) {
                ...
                config = {
                    ...
                    tipo: 'excel',
                    logo: `${nit}.png`,
                    header: [empresa.toUpperCase(), 'CONTROL RESPUESTA DE CORRESPONDENCIA', `FECHA: ${fecha_ini} - ${fecha_fin}`],
                    tabla: {
                        columnas: header_tabla,
                        data: data_format
                    }
                }
            }
