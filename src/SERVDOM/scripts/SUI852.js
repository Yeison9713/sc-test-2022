// Resumen SUI Facturación Energia - Opcion 8-6-2 - David.M - 10/09/2021
...
new Vue({
  ...
  created() {
    nombreOpcion("8-6-2 - Facturación Energia");
    _inputControl("reset");
  ...
  methods: {
    ...
    llamarDLL() {
      CON851P("00", this.datoFechaArchivo, () => {
        ...
        postData(datos, get_url("app/SERVDOM/SUI852.DLL"), {
          onProgress: (progress) => {
    ...
    async format_csv(datos) {
      ...
      _impresion2({
        ...
        archivo: `EN${this.fecha_act.slice(0, 6)}`,
        datos: datos,
