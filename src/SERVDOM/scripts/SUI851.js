// Resumen SUI Usuarios Energia - Opcion 8-6-1 - David.M - 10/09/2021
...
new Vue({
  ...
  created() {
    nombreOpcion("8-6-1 - Usuarios Energia");
    _inputControl("reset");
  ...
  methods: {
    ...
    llamarDLL() {
      CON851P("00", this.datoFechaArchivo, () => {
        ...
        postData(datos, get_url("app/SERVDOM/SUI851.DLL"), {
          onProgress: (progress) => {
    ...
    async format_csv(datos) {
      ...
      _impresion2({
        ...
        archivo: `EN-US${this.fecha_act.slice(0, 6)}`,
        datos: datos,
