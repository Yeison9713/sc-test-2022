// Resumen SUI Facturación Energia no Residencial - Opcion 8-6-4 - David.M - 10/09/2021
...
new Vue({
  ...
  created() {
    nombreOpcion("8-6-4 - Facturación Energia");
    _inputControl("reset");
  ...
  methods: {
    ...
    llamarDLL() {
      CON851P("00", this.datoFechaArchivo, () => {
        ...
        postData(datos, get_url("app/SERVDOM/SUI854.DLL"), {
          onProgress: (progress) => {
    ...
    async format_csv(datos) {
      ...
      _impresion2({
        ...
        archivo: `EN-C2${this.fecha_act.slice(0, 6)}`,
        datos: datos,
