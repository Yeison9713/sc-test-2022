// Usuarios x direccion - Opcion 4-3 - David.M - 31/07/2021
...
new Vue({
    ...
    created() {
      nombreOpcion("4-3 - Catalogo de Usuarios por Dirección");
      _inputControl("reset");
    ...
    methods: {
      ...
      llamarDLL() {
        CON851P("00", _toggleNav, () => {
          ...
          postData({ datosh: moduloDatosEnvio() }, get_url("app/SERVDOM/PUB403.DLL"), {
            onProgress: (progress) => {
