module.exports = Vue.component("ser7621o", {
    props: {
        params: {},
    },
    data() {
    ...
    methods: {
        ...
        _ValidarNroOrigen() {
            ...
            loader("show");
            postData(datos, get_url("APP/SALUD/SER7621O.DLL"))
                .then((data) => {
                    loader("hide");
                    if (parseFloat(data) > 0) {
                        CON851("", "No existe folio", null, "warning", "");
                        _ser7621o._validarProceso();
                    } else _ser7621o._faseSucFolioDes();
                })
                .catch((err) => {
                    loader("hide");
                    _ser7621o.init();
        ...
        _faseSucFolioDes() {
            ...
            validarInputs(
                ...
                _ser7621o._faseSucFolioOrigen,
                () => {
                    if (_ser7621o.form.destino.suc == '**') {
                        _ser7621o._faseSucFolioDes()
                        CON851("03", "03", null, "warning", "");
                    } else _ser7621o._consultarFolioDes()
                }
            );
        },
        _consultarFolioDes() {
            ...
            postData(datos, get_url("APP/SALUD/SER7621O.DLL"))
                .then((data) => {
                    loader("hide");
                    _ser7621o.form.destino.folio = data.padStart(6, "0");
                    _ser7621o._validarProceso();
                })
                .catch((err) => {
                    loader("hide");
        ...
        _consultarHistorias(tipo) {
            ...
            postData(datos, get_url("APP/ODONTO/OD811.DLL"))
                .then(res => {
                    loader("hide")
        ...
        <div class="modal-mask">
            <div class="modal-wrapper">
                <div class="box-center col-lg-8 col-md-10 col-sm-10 col-xs-12">
                    <div id="ser7621o" class="form-group box-center col-md-12 no-padding">
                        <div class="col-12">
                            <div class="portlet light box-center box-title">
                                <div class="portlet-title">
                                    <div class="caption" style="width: 100%">
                                        <span class="caption-subject bold uppercase">Unifica historias de odontologia</span>
                                    </div>
                                </div>
                            </div>
