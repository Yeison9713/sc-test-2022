        ...
        pageButton: {
            _: function (a, b, c, d, e, f) {
                var g = a.oClasses,
                            ...
                            if (h.isArray(s)) {
                                ...
                                switch (s) {
                                    case "ellipsis":
                                        ...
                                        break;
                                    case "first":
                                        m = j.sFirst; l = s + (e > 0 ? "" : " " + g.sPageButtonDisabled);
                                        break;
                                    case "previous":
                                        m = j.sPrevious; l = s + (e > 0 ? "" : " " + g.sPageButtonDisabled);
                                        break;
                                    case "next":
                                        m = j.sNext; l = s + (e < f - 1 ? "" : " " + g.sPageButtonDisabled);
                                        break;
                                    case "last":
                                        m = j.sLast; l = s + (e < f - 1 ? "" : " " + g.sPageButtonDisabled);
                                        break;
                                    default: m = s + 1; l = e === s ? g.sPageButtonActive : ""
                                }
                    ...
                    t; try { t = h(b).find(H.activeElement).data("dt-idx") } catch (u) { } r(h(b).empty(), d);
    ...
    h.extend(m.ext.type.detect, [
        ...
        function (a) {
            if (a && !(a instanceof Date) && !cc.test(a))
                return null; var b = Date.parse(a);
        ...
        header: {
            ...
            jqueryui: function (a, b, c, d) {
                ...
                h(a.nTable).on("order.dt.DT",
                    function (e, f, g, h) {
                        if (a === f) {
                            e = c.idx; b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass(h[e] == "asc" ? d.sSortAsc : h[e] == "desc" ? d.sSortDesc : c.sSortingClass);
